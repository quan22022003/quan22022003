...
- [Bayesian Modeling for International Trade Forecasting](https://github.com/quan22022003/Bayesian-International-Trade-Forecasting) - Developing and implementing Bayesian hierarchical and time series models to model heteroskedasticity and forecast regional growth rates of imports and exports for a data science project in collaboration with OP Group.
